...
transform_test = transforms.Compose(
        [
         ...
         transforms.ToTensor(),
    transforms.Normalize((0.4221, 0.4473, 0.3362), (0.2345, 0.2329, 0.2433))
     ])

transform_train = transforms.Compose(
        [transforms.Resize([256, 256]),
         transforms.ToTensor(),
     transforms.Normalize((0.4298, 0.4588, 0.3523), (0.2322, 0.2313, 0.2459))
    ])


batch_size = args.bs

trainset = torchvision.datasets.ImageFolder(root='/workspace/PlantCLEF_Subset/train', transform=transform_train)

testset = torchvision.datasets.ImageFolder(root='/workspace/PlantCLEF_Subset/val', transform=transform_test)
