...
transform_test = transforms.Compose(
        [
         ...
         transforms.ToTensor(),
    transforms.Normalize((0.4867, 0.4990, 0.4287), (0.2273, 0.2221, 0.2613))
     ])
...
transform_train = transforms.Compose(
        [transforms.Resize([256, 256]),
         ...
         transforms.ToTensor(),
     transforms.Normalize((0.4855, 0.4993, 0.4318), (0.2274, 0.2227, 0.2613))
    ])
...
testset = torchvision.datasets.ImageFolder(root='/workspace/test', transform=transform_test)
