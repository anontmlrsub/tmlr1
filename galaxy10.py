...
trainset = CustomImageDataset(train_images, train_labels, transform=transforms.ToTensor())
print(len(trainset))
...
optimizer = optim.AdamW(model.parameters(), lr=0.0001, betas=(0.9, 0.999), eps=1e-08, weight_decay=0.01, amsgrad=False)
