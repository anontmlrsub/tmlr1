...
transform_train = transforms.Compose(
        [   
            ...
            transforms.ToTensor(),
     transforms.Normalize((0.5453, 0.4438, 0.3439), (0.2698, 0.2722, 0.2768))
     ])

transform_test = transforms.Compose(
        [  transforms.Resize([256,256]),
            transforms.ToTensor(),
     transforms.Normalize((0.5486, 0.4471, 0.3466), (0.2649, 0.2689, 0.2760))
     ])
...
root_dir = '/workspace/food-101'

# Create training and validation datasets
trainset = Food101Dataset(root_dir=root_dir, split='train', transform=transform_train)
testset = Food101Dataset(root_dir=root_dir, split='test', transform=transform_test)
...
traintime = []
testtime = []
counter = 10  # number of epochs without any improvement in accuracy before we stop training for each optimizer
